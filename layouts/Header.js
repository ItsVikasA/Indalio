      ...
      {single ? (
        ...
        <nav id="mobile-menu" className="d-none d-xl-block">
          <ul>
            ...
            <li>
              <Link href="service-details">Products</Link>
            </li>
            ...
            <div className="offcanvas__content">
              <div className="offcanvas__top mb-5 d-flex justify-content-between align-items-center">
                <div className="offcanvas__logo">
                  <Link href="/">
                    <img src="assets/img/logo/logo.png" alt="Indalio Logo" style={{maxHeight: '70px', width: 'auto'}} />
                  </Link>
                </div>
              ...
              <p className="text d-none d-xl-block mb-5">
                Indalio - Premium workspace accessories engineered in Ludhiana. Specializing in gas spring monitor arms, wall-mounted solutions, and cable management systems for modern workspaces.
              </p>
              <div className="offcanvas__contact">
                ...
                <ul>
                  ...
                  <li className="d-flex align-items-center">
                    ...
                    <div className="offcanvas__contact-text">
                      <a href="mailto:business@indalio.com">business@indalio.com</a>
                    </div>
                  </li>
                  <li className="d-flex align-items-center">
                    <div className="offcanvas__contact-icon mr-15">
                  ...
                  <li className="d-flex align-items-center">
                    ...
                    <div className="offcanvas__contact-text">
                      <a href="tel:+919988092664">+919988092664</a>
                    </div>
                  </li>
                </ul>
        ...
        <div className="container-fluid">
          <div className="mega-menu-wrapper">
            <div className="header-main">
              <div className="sticky-logo">
                <Link href="/">
                  <img src="assets/img/logo/logo.png" alt="Indalio Logo" style={{maxHeight: '70px'}} />
                </Link>
              </div>
              <div className="header-left">
                <div className="mean__menu-wrapper">
