  ...
  return (
    <footer className="footer-section footer-bg">
      <div className="container">
        <div className="discussed-items" style={{padding: '25px 0 30px'}}>
          <div className="footer-logo wow fadeInUp" data-wow-delay=".3s">
            <Link href="/">
              <img src="assets/img/logo/logo.png" alt="logo-img" style={{maxHeight: '45px'}} />
            </Link>
          </div>
          <div className="discussed-content wow fadeInUp" data-wow-delay=".5s">
            <h2 style={{fontSize: '1.3rem', marginBottom: '0.8rem', lineHeight: '1.3'}}>
              Let's Discussed About <span>Your Projects</span>
            </h2>
            <Link href="contact" className="theme-btn hover-white" style={{padding: '8px 20px', fontSize: '0.85rem'}}>
            ...
            >
              <div className="single-footer-widget">
                ...
                <div className="footer-content">
                  <p>
                    Indalio manufactures premium gas-spring monitor arms and cable management solutions from Ludhiana, Punjab. Serving corporate offices, IT companies, and furniture dealers nationwide.
                  </p>
              ...
              <div className="single-footer-widget">
                ...
                <div className="contact-info-area">
                  ...
                  <div className="contact-items">
                    ...
                    <div className="content">
                      <a href="mailto:business@indalio.com" className="link">
                        business@indalio.com
                      </a>
                    </div>
                  </div>
                  <div className="contact-items">
                    ...
                    <div className="content">
                      <h4>
                        <a href="tel:+919988092664">+91 9988092664</a>
                      </h4>
                    </div>
                  </div>
                </div>
          ...
          <div className="row">
            ...
            >
              <div className="single-footer-widget">
                <div className="widget-head">
                  <Link href="/">
                    <img src="assets/img/logo/logo/logo.png" alt="logo-img" />
                  </Link>
                </div>
                <div className="footer-content">
                  <p>
